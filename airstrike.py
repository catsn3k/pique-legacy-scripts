"""
airstrike.py by catsn3k and utf-4096 https://github.com/utf-4096
Airstrikes. Boom!
...
from pyspades.contained import OrientationData, GrenadePacket
...
@target_player
def givestrike(connection, player):
